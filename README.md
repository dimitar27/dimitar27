...
<!--
**dimitar27/dimitar27** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
During my bootcamp, I’ve covered a range of topics in Python. Here’s a breakdown of the key units and concepts I’ve learned so far:
...
- **Full-stack Development**: Building web applications using **Flask** for backend and **HTML/CSS** for frontend.
